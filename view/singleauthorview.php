...
<div class="container pt-3">
    ...
    <div class="m-auto col-12 col-lg-6 border bg-light p-3 d-flex flex-column align-items-center">
        ...
        <div id="username-div" class="<?php if ($sRole == "User" || $sRole == "Admin") echo "editable-div"; ?> position-relative rounded" <?php if ($sRole == "User" || $sRole == "Admin") echo 'onclick="editBox(this)"'; ?>>
            <h2 class="text-primary text-center p-2"><?php echo $authordetails["Name"]; ?></h2>
            <i class="fas fa-pen-square position-absolute fs-5"></i>
        </div>
        
        <div id="name-div" class="<?php if ($sRole == "User" || $sRole == "Admin") echo "editable-div"; ?> position-relative p-2 rounded" <?php if ($sRole == "User" || $sRole == "Admin") echo 'onclick="editBox(this)"'; ?>>
